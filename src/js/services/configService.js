...
angular.module('copayApp.services').service('configService', function(storageService, lodash, $log, $timeout, $rootScope, platformInfo) {
  ...
  var defaultConfig = {
    ...
    bws: {
      url: 'https://bws.sparkspay.io/bws/api',
    },

    download: {
      sparks: {
        url: 'https://github.com/sparkspay/copay-sparks/releases/latest'
      }
    },
    ...
    rates: {
      url: 'https://insight.sparkspay.io/insight/insight-api-sparks/currency',
    },
